...
public class GameOverScreen : MonoBehaviour
{
    ...
    private string[] tips = new string[49]
    {
 ...
 "Black Cats are small enemies with surge guns. The color of the bullets indicates in which direction the surge will occur. Red is Up, Yellow is Left, Green is Bottom and Blue is Right",
 ...
 "Because Multishot 2 and Dice Loyalty trivialize the majority of encounters in the game, they are intentionally reserved for late-game chaos.",
 ...
 "Successful attempts at defeating the game's final boss may add unwelcome visitors to the roster.",
 "The final boss was naked in the earliest phase of development.",
 "I like to obliterate my enemies and watch them drop dead when I activate Myriad Cookies.",
 ...
 "The was a creepy jumpscare of the whale in development, but it was deemed too un-whale-like, so you'll get a cute whale instead"
    };
