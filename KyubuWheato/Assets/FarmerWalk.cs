...
public class FarmerWalk : StateMachineBehaviour
{
    ...
    override public void OnStateUpdate(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
    {
        ...
        else if (randomNumberScript.AttackRolled <= 4 && randomNumberScript.AttackRolled >= 2 && Vector2.Distance(player.position, bossRB.position) <= attackRange) { animator.SetTrigger("Slice"); }
        else if (randomNumberScript.AttackRolled > 4) { animator.SetTrigger("Summon"); }
        else {}
    }
